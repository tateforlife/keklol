          ...
          <div>
            <div className='carousel__item'>
              ...
              Read more in the Whitepaper
                ...
                <p className="carousel__paragraph">
                  <span>Leaderboard pool of rewards.</span> Played once a week among the most active participants of the project, a jackpot that allows you to multiply your investments 10 times in just 5 minutes and much more.
                </p>
              </div>
            </div>
          </div>
